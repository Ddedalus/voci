...
Why voci is shaped the way it is - back story on decisions made. It covers important choices only, where no natural documentation exists in code or docs.
...
- [rationale/isolated.md](rationale/isolated.md) — `_run/isolated.py`, the `@voci.isolated` subprocess tier
