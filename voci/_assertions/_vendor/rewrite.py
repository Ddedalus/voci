...
# Source: _pytest/assertion/rewrite.py
...
from voci._assertions._vendor.saferepr import DEFAULT_REPR_MAX_SIZE
from voci._assertions._vendor.saferepr import saferepr
from voci._assertions._vendor.saferepr import saferepr_unlimited
from voci._assertions._vendor._shim import version
from voci._assertions._vendor import util
from voci._assertions._vendor._shim import Config
from voci._assertions._vendor._shim import FixtureFunctionDefinition
from voci._assertions._vendor._shim import Session
from voci._assertions._vendor._shim import absolutepath
from voci._assertions._vendor._shim import fnmatch_ex
from voci._assertions._vendor._shim import StashKey


# fmt: off
from voci._assertions._vendor.util import format_explanation as _format_explanation  # noqa:F401, isort:skip
# fmt:on

if TYPE_CHECKING:
    from voci._assertions._vendor._shim import AssertionState
...
class AssertionRewriter(ast.NodeVisitor):
    ...
    def run(self, mod: ast.Module) -> None:
        ...
        aliases = [
            ...
            ast.alias(
                "voci._assertions._vendor.rewrite",
                "@pytest_ar",
                lineno=lineno,
                col_offset=0,
            ),
