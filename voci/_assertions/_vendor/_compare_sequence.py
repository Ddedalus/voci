...
# Source: _pytest/assertion/_compare_sequence.py
...
from voci._assertions._vendor._pprint import PrettyPrinter
...
from voci._assertions._vendor._shim import running_on_ci
