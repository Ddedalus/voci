...
# Source: _pytest/assertion/compare_text.py
...
from voci._assertions._vendor.highlight import dummy_highlighter
from voci._assertions._vendor._shim import assert_never
