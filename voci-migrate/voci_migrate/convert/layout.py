...
voci wires dependencies by importing the fixture object, so the file layout is the wiring: a
...
def dotted(module: str) -> str:
    ...
    Always absolute and rootdir-relative: voci imports test modules under synthetic
    `voci_tests.*` names, so a relative import between two of them resolves against nothing.
    """
