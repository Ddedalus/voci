"""Tests for voci_migrate.extractor: the plugin's output, its options, and its independence."""
...
from voci_migrate import extractor, schema
...
def test_the_extractor_imports_nothing_from_the_rest_of_the_package() -> None:
    ...
    assert "voci_migrate" not in imported
