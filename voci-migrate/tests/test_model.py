"""Tests for voci_migrate.model: fixture chains, per-test resolution, and the version shims.
...
from voci_migrate import model, schema
from voci_migrate.schema import DumpError
