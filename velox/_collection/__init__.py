...
executes, resolving each test's dependency-injection plan via `velox._di.fixtures`. `requires.py`
holds `velox.use(...)`, by which a module declares fixtures for every test it defines.
"""
